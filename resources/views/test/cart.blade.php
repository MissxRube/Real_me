									...
									@foreach($AllProducts as $key=> $cart)
										...
										<td class="image" data-title="No"><img src="#"></td>
											<td class="product-des" data-title="Description">
												<p class="product-name"><a href="{{route('detail',$cart->product['id'])}}" target="_blank">{{$cart->product['title']}}</a></p>
											</td>
											<td class="price text-center" data-title="Price"><span>${{number_format($cart['price'])}}</span></td>

                      <td class="quantity-form" data-title="Qty">
                        <button type="button" class="decrement btn btn-number" data-type="minus" data-field="quant[{{$key}}]"><i class="fas fa-minus"></i></button>
                        ...
                        <button type="button" class="increment btn btn-number" data-type="plus" data-field="quant[{{$key}}]"><i class="fas fa-plus"></i></button>
											...
											<td class="total-amount cart_single_price text-center" data-title="Total"><span class="money">${{$cart['amount']}}</span></td>

											 <td class="action" data-title="Remove"><a href="{{route('cart-delete',$cart->id)}}"><i class="fas fa-trash-alt"></i></a></td>
										</tr>
									@endforeach
									<track>
										<td></td>
