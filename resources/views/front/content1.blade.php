...
@section('homecontent')
                ...
                <div class="row bg-image">
                        ...
                        <div class="col-12 infobox position-absolute " style="top:130%">
                                <div class="border bg-infode2"  id="infobar">
                                                                <!-- p-0清邊框 m-1外邊框劉1  -->
                                        <div class="col-8 offset-2  mx-auto">
                                                <div class="d-flex align-items-center ">
                                                        ...
                                                        <h3 class="text-center pl-4 pt-4">珍稀花材 -- 格拉斯玫瑰，繽紛花香氣息帶些柑橘香氣。</h3>

                                                </div>

                                                <div class="embed-responsive embed-responsive-16by9 pb-5">
                                                        <video src="https://secure.massmotionmedia.com/diorparfums/projects/diorparfums_miss_dior_made_with_love_teaser/videos/20191119155322_960x540_1312_dd961543-4d10-42d2-a7c4-9eadf5885a5f.mp4" loop autoplay muted class=" embed-responsive-item"></video>
                                                </div >
                        ...
                        <div class="col-8 offset-2 h5 text-center wow fadeInUp"><a href="#"><img src="{{asset($k[0]->topproductpic)}}" alt="" class="class-fluid"></a></div>
