...
@section('homecontent')
                ...
                <div class="row bg-image">
                        ...
                        <div class="col-12 infobox position-absolute " style="top:130%">
                                <div class="border bg-infode1"  id="infobar">
                                                                <!-- p-0清邊框 m-1外邊框劉1  -->
                                        <div class="col-8 offset-2  mx-auto">
                                                ...
                                                <div class="embed-responsive embed-responsive-16by9 pb-5">
                                                        <video src="https://secure.massmotionmedia.com/diorparfums/projects/diorparfums_joy_joy_intense_olfactif_19s/videos/20190722101344_960x540_1332_547c43e6-0841-4878-9680-73dcf2ee030c.mp4" loop autoplay muted class=" embed-responsive-item"></video>
                                                </div >
